 ...
 */
    ...
    private static void generateData() throws Exception {
        ...
        Meal meal2 = new Meal("Spaghetti Carbonara", "Pasta with pancetta, eggs, and Parmesan cheese", "pasta, pancetta, egg, parmesan", 13.99 , "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal1.jpg", "shared meal");

        Meal meal3 = new Meal("Lasagna", "Layered pasta with rich meat sauce and creamy béchamel", "pasta, beef, tomato sauce, béchamel", 14.99, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal2.jpg", "shared meal");

        Meal meal4 = new Meal("Risotto alla Milanese", "Creamy risotto with saffron and Parmesan", "rice, saffron, parmesan, butter", 12.99, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal3.jpg", "shared meal");

        Meal meal5 = new Meal("Fettuccine Alfredo", "Pasta in a creamy Parmesan cheese sauce", "fettuccine, cream, parmesan, butter", 12.49, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal4.jpg", "shared meal");

        Meal meal6 = new Meal("Penne Arrabbiata", "Penne pasta with a spicy tomato and garlic sauce", "penne, tomato, garlic, chili", 11.99, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal5.jpg", "special2");

        Meal meal7 = new Meal("Ravioli Ricotta e Spinaci", "Pasta pockets filled with ricotta cheese and spinach", "ricotta, spinach, ravioli, nutmeg", 13.49, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal6.jpg", "special3");

        Meal meal8 = new Meal("Calzone Classico", "Folded pizza with ham, mozzarella, and mushrooms", "ham, mozzarella, mushroom, dough", 13.49, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal7.jpg", "special1");

        Meal meal9 = new Meal("Arancini", "Fried risotto balls stuffed with cheese and peas", "rice, cheese, peas, breadcrumbs", 8.49, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal8.jpg", "special2");

        Meal meal10 = new Meal("Polenta ai Funghi", "Creamy polenta topped with sautéed wild mushrooms", "polenta, mushrooms, garlic, butter", 11.49, "/il/cshaifasweng/OCSFMediatorExample/client/meals/meal9.jpg", "special3");
