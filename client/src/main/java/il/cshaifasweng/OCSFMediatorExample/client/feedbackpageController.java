...
import static il.cshaifasweng.OCSFMediatorExample.client.ocsf.SessionManager.getCurrentUserId;
...
public class feedbackpageController implements Initializable {
    ...
    void submitFeedbackOnAction(ActionEvent event) throws IOException {
        ...
        String msg = String.format("feedback;%d;%s;%d", getCurrentUserId(), feedbackText, rating);
