...
public class User implements Serializable {
    ...
    protected short permissionLevel;

    @ManyToOne
    @JoinColumn(name = "restaurant_id", nullable = false)
    protected Restaurant restaurant;  // The restaurant this user is associated with

    @Transient
    protected String messageToServer;

    @Transient
    protected short restaurantInterest;

    @Transient
    protected Restaurant restaurantInterestentity;
